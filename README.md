...
**Muster 0.0.2.** Take the file for your system, or browse the
...
|---|---|---|
| Windows | [Installer](https://github.com/Spillebulle/muster/releases/download/v0.0.2/muster-setup-0.0.2-x64.exe) | [Installer](https://github.com/Spillebulle/muster/releases/download/v0.0.2/muster-setup-0.0.2-arm64.exe) |
| Debian, Ubuntu, Mint | [`.deb`](https://github.com/Spillebulle/muster/releases/download/v0.0.2/muster_0.0.2_amd64.deb) | [`.deb`](https://github.com/Spillebulle/muster/releases/download/v0.0.2/muster_0.0.2_arm64.deb) |
| Fedora, RHEL, openSUSE | [`.rpm`](https://github.com/Spillebulle/muster/releases/download/v0.0.2/muster-0.0.2-1.x86_64.rpm) | [`.rpm`](https://github.com/Spillebulle/muster/releases/download/v0.0.2/muster-0.0.2-1.aarch64.rpm) |
| Arch | [`.pkg.tar.zst`](https://github.com/Spillebulle/muster/releases/download/v0.0.2/muster-bin-0.0.2-1-x86_64.pkg.tar.zst) | not built |
| Any other Linux | [AppImage](https://github.com/Spillebulle/muster/releases/download/v0.0.2/Muster-0.0.2-x86_64.AppImage), one file with nothing to install | [AppImage](https://github.com/Spillebulle/muster/releases/download/v0.0.2/Muster-0.0.2-aarch64.AppImage) |
| Flatpak | [`.flatpak` bundle](https://github.com/Spillebulle/muster/releases/download/v0.0.2/muster-0.0.2-x86_64.flatpak) | not built |
| Windows, `.msi` to deploy | [`.msi`](https://github.com/Spillebulle/muster/releases/download/v0.0.2/muster-0.0.2-x64.msi) | [`.msi`](https://github.com/Spillebulle/muster/releases/download/v0.0.2/muster-0.0.2-arm64.msi) |
| Windows, no installer | [`.zip`](https://github.com/Spillebulle/muster/releases/download/v0.0.2/muster-0.0.2-x86_64-pc-windows-msvc.zip) | [`.zip`](https://github.com/Spillebulle/muster/releases/download/v0.0.2/muster-0.0.2-aarch64-pc-windows-msvc.zip) |
| Linux, no package | [`.tar.gz`](https://github.com/Spillebulle/muster/releases/download/v0.0.2/muster-0.0.2-x86_64-unknown-linux-gnu.tar.gz) | [`.tar.gz`](https://github.com/Spillebulle/muster/releases/download/v0.0.2/muster-0.0.2-aarch64-unknown-linux-gnu.tar.gz) |
